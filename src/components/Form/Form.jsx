...
const Form = () => {
    ...
    return (
        <Grid>
            <Card style={{ maxWidth: 450, padding: "20px 5px", margin: "0 auto", backgroundColor: "transparent" }} className='contact-form'>
                <CardContent sx={{ width: "100%" }}>
                    ...
                    <Card style={{ maxWidth: 450, padding: "20px 5px", margin: "0 auto", backgroundColor: "transparent" }}>
